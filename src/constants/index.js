...
const WORK_LOCATION = {
  ...
  children: [
    ...
    },
    {
      ...
      windowPosition: "top-[8vh] left-79",
      children: [
        {
          id: 1,
          ...
          position: "top-5 left-10",
          description: [
            "This portfolio website is a sleek, macOS-inspired experience designed to showcase my work through smooth, desktop-like interactions.",
            "Instead of a simple personal site, it delivers an interactive interface with dock buttons, draggable windows, and reusable high-order components that mimic the feel of a real operating system.",
            "Think of it like exploring a mini macOS environment—each click opens a new window, every movement responds fluidly, and the animations create a polished, immersive experience.",
            "It's built with React, Vite, GSAP, and Framer Motion, ensuring smooth performance, refined animations, and an experience optimized specifically for desktop users.",
          ],
        },
        {
          id: 2,
          name: "haruna-web.netlify.app",
          icon: "/images/safari.png",
          kind: "file",
          fileType: "url",
          href: "https://haruna-web.netlify.app/",
          position: "top-10 right-20",
        },
        {
          id: 3,
          ...
          kind: "file",
          fileType: "url",
          href: "https://github.com/harunaGuru/macos_portfolio",
          position: "top-60 right-20",
        },
        {
          id: 4,
